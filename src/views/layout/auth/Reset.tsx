            ...
            <div className="col-sm-8 col-md-6 p-2">
                ...
                <div className="card mb-5 p-2">
                    <div className="card-body">
                        ...
                        <Fields css="col-md-10 offset-md-1" onChange={(event) => { setPassword(event?.target.value); } } field={'password'} placeHolder='Enter your Password' icon={'unlock-fill'} fieldType={'confirmPassword'}/>
