...
export const DeleteQuestionaire = () => 
{
  ...
  return (
    <>
        <div className="modal fade" id="deleteQuestionaire">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                    <h5 className="modal-title">Delete Questionaire</h5>
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div className="modal-body">
                        <div className="row p-4" style={{marginLeft: '30px'}}>
                            <h6>You are about to take an action to delete a questionaire folder and all file it contain will also be deleted</h6>
                        </div>
                    </div>
