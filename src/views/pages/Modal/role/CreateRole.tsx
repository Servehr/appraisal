...
export const CreateRole = () => 
{
  ...
  return (
      <div className="modal fade" id="createRole">
                    ...
                    <div className="modal-body">
                        <div className="row p-4">
                            <div className="col-sm-12 form-group">
                              <Fields css="col-12 px-2" onChange={(event) => { setRoleName(event?.target.value); } } field={'text'} placeHolder='Enter Role Name' fieldType={'departmentName'}/>
                            </div>                
                            <div className="col-sm-12">
                                <TextArea id={'companyAddress'} name={'companyAddress'} rows={2} cols={10} placeholder={'Enter Role Description'} onChange={(event) => setRoleDescription(event.target.value)} label={false}></TextArea>
                            </div>
                        </div>
                    </div>
