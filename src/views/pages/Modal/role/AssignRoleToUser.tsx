...
export const AssignRoleToUser = () => 
{
    ...
    return (
        <div className="modal fade" id="assignRolesToUser">
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                    <h5 className="modal-title">Attach Privilege To Role</h5>
                    ...
                    <div className="modal-body">
                        <div className="row p-4">
                            ...
                            <div className='col-12 px-2 mb-2'>
                                <SelectOption defaultValue={[{ id: -1, text: "Select Privilege" }]} options={privilege.right} fieldType={'privilege'} />
                            </div>
                        </div>
                    </div>
