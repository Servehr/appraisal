...
export const EditPermission = () => 
{
    ...
    return (
        <div className="modal fade" id="editPermission">
                      ...
                      <div className="modal-body">
                          <div className="row p-4">
                              <div className="col-sm-12 form-group">
                                <Fields css="col-12 px-2" onChange={(event) => { setPermissionName(event?.target.value); } } field={'text'} placeHolder='Edit Permission Name' fieldType={'privilegeName'}/>
                              </div>                
                              <div className="col-sm-12">
                                  <TextArea id={'privilegeDescription'} name={'privilegeDescription'} rows={2} cols={10} placeholder={'Edit Permission Description'} onChange={(event) => setPermissionDescription(event.target.value)} label={false}></TextArea>
                              </div>
                          </div>
                      </div>
