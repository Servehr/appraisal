...
import { CreateRole } from './Modal/role/CreateRole';
import { EditRole } from './Modal/role/EditRole';
import { AssignRoleToUser } from './Modal/role/AssignRoleToUser';
import { DeleteRole } from './Modal/role/DeleteRole';
    ...
    <>
        ...
        <main id="main" className="main" style={{height: '100vh'}}>
            ...
            <div className="row mb-5" style={{paddingRight: '8px', paddingLeft: '10px'}}>
                <div className="col-2">
                    <div className="col">
                        <i className="bi bi-file-plus-fill float-start" data-bs-toggle="modal" data-bs-target="#createRole" style={{fontSize: '34px', color: '#444444', marginTop: '1px', cursor: 'pointer', float: 'right'}}></i>
                        <i className="bi bi-file-plus-fill float-start" data-bs-toggle="modal" data-bs-target="#assignRolesToUser" style={{fontSize: '34px', color: '#7f7c7c', marginTop: '1px', cursor: 'pointer', float: 'left'}}></i>
                    </div>
                </div>            
            ...
            <section className="section dashboard container">
                <div className="container">
                    ...
                    <div className="row gx-1">
                            {
                                roles.list.map((role: any, index: number) => {
