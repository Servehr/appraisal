    ...
    <>
        ...
        <main id="main" className="main" style={{height: '100vh'}}>
            ...
            <div className="row mb-5" style={{paddingRight: '8px', paddingLeft: '10px'}}>
                <div className="col-2">
                    <div className="col">
                        <i className="bi bi-file-plus-fill float-start" data-bs-toggle="modal" data-bs-target="#createRole" style={{fontSize: '34px', color: 'blue', marginTop: '1px', cursor: 'pointer', float: 'right'}}></i>
                        <i className="bi bi-file-plus-fill float-start" data-bs-toggle="modal" data-bs-target="#assignRolesToUser" style={{fontSize: '34px', color: 'green', marginTop: '1px', cursor: 'pointer', float: 'left'}}></i>
                    </div>
                </div>            
